 ...
 <!-- Page Banner -->
	<div id="page-banner" class="page-banner">
		...
		<div class="page-detail">
			<div class="container">
				<h3 class="page-title">School Cleaning</h3>
	  ...
	  <div class="carpet">
	   <div class="row">
	      <div class="col-lg-12 carpet-cleanig">
		     <div class="col-md-6">
			     <div class="img">
				    <img src="<?php the_field('school_cleaning_image'); ?>"/>
				 </div>
			 </div>
			  <div class="col-md-6">
			     <div class="content">
				    <h2><?php the_field('school_cleaning_heading'); ?></h2>
					<p class="carpet-para"><?php the_field('school_cleaning_text'); ?></p>
