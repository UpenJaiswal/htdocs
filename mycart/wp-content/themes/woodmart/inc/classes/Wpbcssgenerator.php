...
class WOODMART_Wpbcssgenerator {
		...
		<?php if ( $file['file'] ) : ?>
			...
			<div class="css-file-information">
				...
				<div class="css-file-actions">
					<?php if ( version_compare( $data['Version'], WOODMART_WPB_CSS_VERSION, '<' ) ) : ?>
	...
	public function process_form() {
		...
		$response = wp_remote_get( $this->_generator_url . '?generate_css=' . $data . '&wpbakery=1&theme_url=' . urlencode( get_template_directory_uri() ) . '/', array( 'timeout' => 30 ) );
