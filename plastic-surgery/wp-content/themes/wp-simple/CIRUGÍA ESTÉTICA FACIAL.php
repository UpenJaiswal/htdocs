...
get_header(); ?>
        ...
        <div class="page" id="top">
            ...
            <!-- Head Section -->
            <section class="page-section bg-dark-alfa-50 parallax-3" data-background="<?php the_field('procedure_img')?>" style="height:400px;">
                <div class="relative container align-left mt-100">
                    
                    <div class="row">
                        
                        <div class="col-md-8">
                            <h1 class="hs-line-11 font-alt mb-20 mb-xs-0">Procedures</h1>
                        ...
                        <div class="col-md-4 mt-30">
                            <div class="mod-breadcrumbs font-alt align-right">
                               <a href="<?php echo get_home_url(); ?>">Home</a>&nbsp;/&nbsp;<span>Procedures</span>
                            </div>
	...
	<div class="row">
<?php if(get_field('procedures')): ?>		
<div class="col-lg-12 mt-50">
<?php while(has_sub_field('procedures')): ?>	
			<div class="doctor-text">
			<h2><?php the_sub_field('procedures_heading1'); ?></h2>
			<h4><?php the_sub_field('procedures_heading2'); ?></h4>
			<p><?php the_sub_field('procedures_content'); ?></p>
...
<div class="col-lg-12 mt-20">	
			...
			<li><?php the_field('our_services')?></li>
