    ...
    <input type="hidden" id="base_url" value="<?php echo base_url(); ?>">
      ...
      <ol class="breadcrumb">
        <li ><a href="<?php echo base_url('company/role/add') ?> " style="color: white;" class="btn bt btn-primary btn-flat"><i class="fa fa-plus" ></i> Add Role</a></li>
      </ol>
    </section><br>
                        ...
                        <thead>
                         ...
                         // print_r($role);
                          foreach ($role as $value) { ?>
                            ...
                            <td>
                            <?php 
                             echo anchor('company/role/edit/'.base64_encode($value->id), '<i class="fa fa-edit "></i>', ['class'=>'btn btn-primary', 'onclick'=>"return confirm('Do You Want to Edit this Role ? ')"]); 
                           ?></td>
...
$(document).ready(function(){
 ...
 $('#delete_all').click(function(){
  ...
  if(checkbox.length > 0)
  {
   ...
   var url = $('#base_url').val() + 'company/Role/delete_all';
