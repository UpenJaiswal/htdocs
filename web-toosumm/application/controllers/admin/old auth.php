...
class Auth extends CI_Controller
{
	...
	public function register()
	{
		...
		$this->form_validation->set_rules('about_us', $this->lang->line('create_user_validation_company_label'), 'required');

		if ($this->form_validation->run() /*&& $this->upload->do_upload('image')*/ === TRUE)
		{
