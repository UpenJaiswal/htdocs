...
*/
		...
		else
		{
          ...
          $data['logged_in_user'] = $this->ion_auth->user()->row();
			$data['main_content'] = 'admin/auth/create_user';
			$this->load->view('admin/template', $data);
		}
	}
	...
	public function _render_page($view, $data = NULL, $returnhtml = FALSE)//I think this makes more sense
	{
         ...
         }else
        {
          redirect('admin/dashboard', 'refresh');
           ...
           public function profile()
           {
			...
			$data['main_content'] = 'admin/auth/profile';
			$this->load->view('admin/template', $data);
      ...
      if (!$this->form_validation->run('user')){
		     $data['logged_in_user'] = $this->ion_auth->user()->row();
		     $data['main_content'] = 'admin/auth/UpdateUser';
		     $this->load->view('admin/template', $data); 
        }
        else{
	...
	{ 
		...
		//FILE EXTENSION MATCH
			if($profileImage_type != "jpg" && $profileImage_type != "png" && $profileImage_type != "jpeg"&& $profileImage_type != "gif" )
			{
