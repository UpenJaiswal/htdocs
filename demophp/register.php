...
<body>
<div class="large-head"><h1 style=" text-align: center; font-family: 'arial';">Registration Form</h1></div>
<div  style="width:50%; padding:100px 50px 50px 50px; border:5px solid #e6e1e1; margin-left:25%; ">
