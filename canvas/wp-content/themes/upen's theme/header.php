		...
		<header id="header" class="transparent-header full-header" data-sticky-class="not-dark">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.html" class="standard-logo" data-dark-logo="<?php bloginfo ('template_url'); ?>/images/logo-dark.png"><img src="<?php bloginfo ('template_url'); ?>/images/logo.png" alt="Canvas Logo"></a>
						<a href="index.html" class="retina-logo" data-dark-logo="<?php bloginfo ('template_url'); ?>/images/logo-dark@2x.png"><img src="<?php bloginfo ('template_url'); ?>/images/logo@2x.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
								...
								<div class="top-cart-items">
									<div class="top-cart-item clearfix">
										<div class="top-cart-item-image">
											<a href="#"><img src="<?php bloginfo ('template_url'); ?>/images/shop/small/1.jpg" alt="Blue Round-Neck Tshirt" /></a>
										</div>
									...
									<div class="top-cart-item clearfix">
										<div class="top-cart-item-image">
											<a href="#"><img src="<?php bloginfo ('template_url'); ?>/images/shop/small/6.jpg" alt="Light Blue Denim Dress" /></a>
										</div>
										<div class="top-cart-item-desc">
