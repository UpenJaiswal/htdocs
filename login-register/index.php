...
<style>container,container-fluid {
    padding-left: .5rem;
    padding-right: .5rem;
}</style>
</head>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="view_all.php">All Users</a>
            <a class="collapse-item" href="view.php">Active Users</a>
            <a class="collapse-item" href="404"></a>
            <a class="collapse-item" href="blank"></a>
          </div>
        </div>
      </li>
