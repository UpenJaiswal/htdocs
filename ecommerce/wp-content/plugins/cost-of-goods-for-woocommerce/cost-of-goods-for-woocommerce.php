...
final class Alg_WC_Cost_of_Goods {
	...
	function __construct() {
		...
		if ( 'cost-of-goods-for-woocommerce-pro.php' === basename( __FILE__ ) ) {
			require_once( 'includes/pro/class-alg-wc-cost-of-goods-pro.php' );
		}
	...
	function includes() {
		// Functions
		require_once( 'includes/alg-wc-cost-of-goods-functions.php' );
		// Core
	...
	function admin() {
		...
		require_once( 'includes/settings/class-alg-wc-cost-of-goods-settings-section.php' );
		$this->settings = array();
		$this->settings['general'] = require_once( 'includes/settings/class-alg-wc-cost-of-goods-settings-general.php' );
		$this->settings['tools']   = require_once( 'includes/settings/class-alg-wc-cost-of-goods-settings-tools.php' );
		// Version update
	...
	function add_woocommerce_settings_tab( $settings ) {
		$settings[] = require_once( 'includes/settings/class-alg-wc-settings-cost-of-goods.php' );
		return $settings;
	}
