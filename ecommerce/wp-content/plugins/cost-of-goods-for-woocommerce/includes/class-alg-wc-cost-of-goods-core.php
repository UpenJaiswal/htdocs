...
class Alg_WC_Cost_of_Goods_Core {
	...
	function __construct() {
		if ( is_admin() ) {
			...
			// Admin columns & meta boxes
			require_once( 'class-alg-wc-cost-of-goods-admin.php' );
			// Bulk Edit tool
			$this->bulk_edit_tool = require_once( 'tools/class-alg-wc-cost-of-goods-bulk-edit-tool.php' );
			// Import tool
			$this->import_tool    = require_once( 'tools/class-alg-wc-cost-of-goods-import-tool.php' );
		}
