    ...
    class CWG_Instock_Settings {
        ...
        public function default_value() {
            ...
            $success_subscribe_message = "Dear {subscriber_email}, <br/>"
                    . "Thank you for subscribing/opting-in to #{product_name}. You will receive this communication occasionally.";
            $instock_message = "Hello {email_id}, <br/>"
                    . "Thank you for registering for {product_name} sale. {product_name} available for purchase for a limited time until stocks last. <br/> Hurry to add this product {product_name} directly to cart <a href='{cart_link}'>{cart_link}</a>";
