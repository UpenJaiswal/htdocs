...
class AZEXO_Post extends WP_Widget {
    ...
    function form($instance) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:', 'madison'); ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
        </p><p>            
            <label for="<?php echo esc_attr($this->get_field_id('post')); ?>"><?php esc_html_e('Post ID:', 'madison'); ?></label>
        ...
        <p>    
            ...
            <label for="<?php echo esc_attr($this->get_field_id('full')); ?>"><?php esc_html_e('Full post', 'madison'); ?></label>
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('template')); ?>"><?php esc_html_e('Post template:', 'madison'); ?></label>
...
class AZEXO_Taxonomy extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array('classname' => 'widget_categories', 'description' => esc_html__("A list or dropdown of categories.", 'madison'));
    ...
    public function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? esc_html__('Categories', 'madison') : $instance['title'], $instance, $this->id_base);
        ...
        if ($d) {
            ...
            $cat_args['show_option_none'] = esc_html__('Please select', 'madison');
    ...
    public function form($instance) {
        ...
        ?>
        <p><label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:', 'madison'); ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id('taxonomy')); ?>"><?php esc_html_e('Taxonomy:', 'madison'); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id('dropdown')); ?>"><?php esc_html_e('Display as dropdown', 'madison'); ?></label><br />

            <input type="checkbox" class="checkbox" id="<?php echo esc_attr($this->get_field_id('count')); ?>" name="<?php echo esc_attr($this->get_field_name('count')); ?>"<?php checked($count); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('count')); ?>"><?php esc_html_e('Show post counts', 'madison'); ?></label><br />

            <input type="checkbox" class="checkbox" id="<?php echo esc_attr($this->get_field_id('hierarchical')); ?>" name="<?php echo esc_attr($this->get_field_name('hierarchical')); ?>"<?php checked($hierarchical); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('hierarchical')); ?>"><?php esc_html_e('Show hierarchy', 'madison'); ?></label>
        </p>
        <?php
    }
...
class AZEXO_Dashboard_Links extends WP_Widget {
    ...
    public function form($instance) {
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id('visible_if_active')); ?>"><?php esc_html_e('Visible if have active link', 'madison'); ?></label><br />
        </p>
        <?php
    }
...
$azexo_widgets_visibility = array(
    'show_on_dashboard' => esc_html__('Show only on dashboard', 'madison'),
    'hide_on_dashboard' => esc_html__('Hide on dashboard', 'madison'),
    'show_on_profiles_list' => esc_html__('Show only on profiles list', 'madison'),
    'hide_on_profiles_list' => esc_html__('Hide on profiles list', 'madison'),
    'show_on_shop' => esc_html__('Show only on shop', 'madison'),
    'hide_on_shop' => esc_html__('Hide on shop', 'madison'),
);
