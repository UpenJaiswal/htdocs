...
add_filter('azh_replaces', 'restaurant_azh_replaces');

function restaurant_azh_replaces($replaces) {
...
add_action('wp_enqueue_scripts', 'restaurant_azh_enqueue_scripts', 9);

function restaurant_azh_enqueue_scripts() {
