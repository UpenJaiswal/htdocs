...
add_filter('azh_replaces', 'agency2_azh_replaces');

function agency2_azh_replaces($replaces) {
...
add_action('wp_enqueue_scripts', 'agency2_azh_enqueue_scripts', 9);

function agency2_azh_enqueue_scripts() {
