...
add_filter('azh_replaces', 'agency_azh_replaces');

function agency_azh_replaces($replaces) {
...
add_action('wp_enqueue_scripts', 'agency_azh_enqueue_scripts', 9);

function agency_azh_enqueue_scripts() {
