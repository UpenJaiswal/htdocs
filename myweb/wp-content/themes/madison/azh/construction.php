...
add_filter('azh_replaces', 'construction_azh_replaces');

function construction_azh_replaces($replaces) {
...
add_action('wp_enqueue_scripts', 'construction_azh_enqueue_scripts', 9);

function construction_azh_enqueue_scripts() {
