        ...
        azh.azh_show_hide = function() {
            ...
            setTimeout(function() {
                if ($('#wp-content-wrap, #wp-customize-posts-content-wrap').is('.tmce-active')) {
                    ...
                    $('.azh-switcher').text(azh.i18n.switch_to_customizer);
                }
            }, 0);
            setTimeout(function() {
                if ($('#wp-content-wrap, #wp-customize-posts-content-wrap').is('.html-active')) {
                    if (azh.edit) {
                        ...
                        $('.azh-switcher').text(azh.i18n.switch_to_html);
...
//            }
        ...
        if (window === window.parent) {
            if ($('#wp-content-editor-container #content').length) {
                var edit = false;
                if ($('body.post-type-azh_widget').length) {
                    edit = true;
                } else {
                    if ($('#list-table input[value="azh"]').length) {
                        edit = true;
                    }
                }
                if (edit) {
                ...
                azh.azh_show_hide();
                if ($('#wp-content-wrap, #wp-customize-posts-content-wrap').is('.tmce-active') || !edit) {
                    $('.azh-switcher').text(azh.i18n.switch_to_customizer);
                }
