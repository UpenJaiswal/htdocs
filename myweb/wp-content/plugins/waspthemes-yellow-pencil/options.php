...
echo "<ul class='yp-editor-list'>
		...
		<li class='animation-option'>
			...
			<div class='yp-this-content'>
				...
				<p class='yp-alert-warning yp-top-alert yp-lite'>Animation ".__('property not available for lite version.','yp')." <a target='_blank' href='http://waspthemes.com/yellow-pencil/buy'>".__('Go Pro','yp')."?</a></p>
